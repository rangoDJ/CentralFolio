...
// Plain SHA-256, not a slow/keyed hash like bcrypt — deliberately, not an
// oversight. Unlike a password, this "credential" is 32 cryptographically
// random bytes (256 bits of entropy) generated by us, never chosen or reused
// by a human, so brute-forcing the hash is infeasible regardless of hash
// speed; a slow hash would only add needless CPU cost on every request.
