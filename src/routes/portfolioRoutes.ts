...
import { getPortfolios, createOrUpdatePortfolio, removePortfolio, togglePortfolioTrading, getAllDividends, getDividendMetadata, clearDividendCache, snowballFetchDividendMetadataHandler, manualSaveDividendMetadataHandler, deleteDividendMetadataHandler } from "../controllers/portfolioController.js";
...
router.post("/dividend-metadata/:symbol/snowball-fetch", snowballFetchDividendMetadataHandler);
